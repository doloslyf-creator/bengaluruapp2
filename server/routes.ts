...
// Import course-related tables from schema
import {
  properties,
  propertyConfigurations,
  bookings,
  ...
  insertPropertyScoreSchema,
  apiKeysSettings,
  insertApiKeysSettingsSchema,
  googleAnalyticsConfig,
  insertGoogleAnalyticsConfigSchema,
  valuationRequests,
  insertValuationRequestSchema,
  siteVisitBookings,
  insertSiteVisitBookingSchema,
  teamMembers,
  ...
  insertUserSchema,
  videoEducation,
  insertVideoEducationSchema,
  videoCourses,
  videoChapters,
  courseEnrollments,
  insertVideoCourseSchema,
  insertVideoChapterSchema,
  insertCourseEnrollmentSchema,
  reraData,
  insertReraDataSchema,
  civilMepReports,
  insertCivilMepReportSchema,
  legalAuditReports,
  insertLegalAuditReportSchema,
  ...
  insertCivilMepReportAssignmentSchema,
  insertLegalReportAssignmentSchema,
  insertPropertyValuationReportAssignmentSchema,
  leadActivities,
  insertLeadActivitySchema,
  leadNotes,
  insertLeadNoteSchema,
