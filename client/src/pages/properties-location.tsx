...
import { updateMetaTags, generateBreadcrumbSchema, generatePropertySlug, injectSchema } from '@/utils/seo';
                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-4">
                        ...
                        <Button asChild className="w-full">
                          <Link href={`/property/${property.id}/${generatePropertySlug(property)}`}>
                            View Details
