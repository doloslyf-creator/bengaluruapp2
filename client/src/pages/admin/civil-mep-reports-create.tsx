...
import { ArrowLeft, Save, FileText, Building, Wrench, CheckCircle } from "lucide-react";
...
export default function CivilMepReportsCreate() {
    ...
    return section.fields.map((field) => (
      <div key={field.key}>
        ...
        {field.type === "text" ? (
          ...
          <Select onValueChange={(value) => handleFieldChange(section.key, field.key, value)}>
            <SelectTrigger>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Create a comprehensive engineering assessment report
              </p>
            </div>
          </div>
        </div>
            ...
            <TabsContent value="summary" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Provide executive summary and recommendations</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                  ...
                  <div>
                    ...
                    <Select name="investmentRecommendation" defaultValue="conditional">
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <CardContent className="space-y-4">
                  <div className="bg-muted p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground mb-4">
                      Please review all the information you've entered in the previous tabs.
                  ...
                  <Button type="submit" className="w-full" disabled={createReportMutation.isPending}>
                    ...
                    {createReportMutation.isPending ? "Creating Report..." : "Create Report"}
                  </Button>
                </CardContent>
              </Card>
            </TabsContent>
