...
import { Plus, Play, Edit2, Trash2, Users, Clock, Eye, BookOpen, Video } from "lucide-react";
...
export default function VideoEducationPage() {
  ...
  if (isLoading) {
    return (
      <AdminLayout title="Video Education Management">
        <div className="p-6">
              ...
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{videos?.length || 0}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">Active Videos</p>
              ...
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {videos?.reduce((total, video) => total + video.viewCount, 0) || 0}
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {new Set(videos?.map(v => v.category)).size || 0}
                    </p>
                  </div>
                </div>
              </CardContent>
